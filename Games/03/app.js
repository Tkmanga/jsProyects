document.addEventListener('DOMContentLoaded', () => {
    ...
    (function (index)
    {
        ...
        squares[i].onclick = function () {
            //if the square below your curren square is taken you can go on top of it
            if(squares[index + 7].classList.contains('taken')){
                ...
                //if the suyare below you current square is not taknen you cant go here
            }else alert('cant go here')
        }
    })(i)

    //check the board fora  win or lose
    ...
    function checkBoard()
    {
        ...
        for(let y = 0; y< winningArrays.length ; y++){
            ...
            //now check those arrays to see if yhey all have the class of player-one;
